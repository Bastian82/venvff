...
--params   -provide additional options provided by virtualenv, separated by semicolon provided by virtualenv. For example 'python=python3.5;no-download;no-pip'
```